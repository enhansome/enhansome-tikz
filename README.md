...
* [SourceForge](https://github.com/pgf-tikz/pgf) ⭐ 1,343 | 🐛 288 | 🌐 TeX | 📅 2026-08-12 - Code, releases, support and bug reports.
...
* [MartinThoma/LaTeX-examples](https://github.com/MartinThoma/LaTeX-examples/tree/master/tikz) ⭐ 1,688 | 🐛 5 | 🌐 TeX | 📅 2024-10-19 - Contains about 350 TikZ examples from Martin. Thoma.
* [PetarV-/TikZ](https://github.com/PetarV-/TikZ) ⭐ 1,415 | 🐛 1 | 🌐 TeX | 📅 2023-05-05 - A collection of publication-ready PGF/TikZ figures by Petar Veličković.
* [walmes/Tikz](https://github.com/walmes/Tikz) ⭐ 486 | 🐛 0 | 🌐 R | 📅 2025-12-15 - Collection of TikZ art from Prof. Walmes M. Zeviani, contains about 200 TikZ figures, most of which were done to teach statistics.
* [tikz-network](https://github.com/hackl/tikz-network) ⭐ 363 | 🐛 19 | 🌐 TeX | 📅 2021-01-18 - A tool to visualize complex networks in LaTeX.
* [OpenTikZ](https://github.com/opentikz/opentikz) ⭐ 247 | 🐛 0 | 🌐 TeX | 📅 2026-07-12 - An agent skill, many editable TikZ icons, and many parametric templates for academic diagrams.
...
* [PlotNeuralNet](https://github.com/HarisIqbal88/PlotNeuralNet) ⭐ 24,947 | 🐛 89 | 🌐 TeX | 📅 2023-08-21 - Latex code for making neural networks diagrams
...
* [awesome-latex-drawing](https://github.com/xinychen/awesome-latex-drawing) ⭐ 2,040 | 🐛 1 | 🌐 TeX | 📅 2025-05-26 - Drawing Bayesian networks, graphical models, and technical frameworks in LaTeX.
* [matlab2tikz](https://github.com/matlab2tikz/matlab2tikz) ⭐ 1,735 | 🐛 264 | 🌐 MATLAB | 📅 2026-05-31 - Converts MATLAB®/Octave figures to TikZ/pgfplots figures.
* [sane\_tikz](https://github.com/negrinho/sane_tikz) ⭐ 429 | 🐛 0 | 🌐 Python | 📅 2020-11-18 - Create TikZ figures with Python.
* [ktikz](https://github.com/fhackenberger/ktikz) ⭐ 395 | 🐛 15 | 🌐 C++ | 📅 2025-07-28 - Provides a nice user interface for making pictures using TikZ.
